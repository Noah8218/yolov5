...
- Image root for relative paths: `C:\Git\py\KtemData`
- YOLOv5 root: `C:\Git\yolov5\yolov5Master`

Manual run:

```powershell
& ".\.venv\Scripts\python.exe" .\labeling_tcp_client.py --retry --weights ".\best.pt" --model-root ".\yolov5Master" --image-root "C:\Git\py\KtemData"
```
...
```powershell
& ".\.venv\Scripts\python.exe" .\labeling_tcp_client.py --smoke-test --weights ".\best.pt" --image "C:\Git\py\KtemData\Teaching_0.bmp"
```

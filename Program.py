...
import editClass  # 변환된 UI 파일을 import 합니다.
import yolov5Defect
...
class WindowClass(QMainWindow, form_class) :
    ...
    def RunClassification(self):
        yolov5Defect.detect_and_draw(self.qlabel_image)
    ...
    def open_edit_class(self):
        self.edit_class_window = editClass.editClass(self.qlist_Classe, self.classe_list)  # 새로운 editClass 인스턴스를 생성합니다.

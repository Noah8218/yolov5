...
class ImageViewer:
    ...
    def mouseReleaseAction(self, QMouseEvent):
        ...
        self.edit_class_window = selectClass(self.main_class_instance, self.classLists, self.lbrect, self.image_W, self.image_H, self.imageName, self.qimage_scaled)  # 새로운 editClass 인스턴스를 생성합니다.
